...
The total number of accesses in L2 cache is **479**, as can be seen at line 493  under system.cpu_cluster.l2.overall_accesses::total. This value could also be calculated as the sum of misses in icache as dcache in L1 cache minus mshr

139. system.cpu_cluster.cpus.dcache.overall_mshr_hits::total           **32**                       # number of overall MSHR hits
